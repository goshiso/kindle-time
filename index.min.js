...
function render() {
  ...
  var dateText = "".concat(
    date.getMonth() + 1,  // 月份，注意要 +1
    ".",
    date.getDate(),       // 日
    " ",
    urlQuery.l == "en"
      ? ["SUN","MON","TUE","WED","THU","FRI","SAT"][date.getDay()]  // 英文星期
      : ["日","月","火","水","木","金","土"][date.getDay()] // 日文星期
  );
//  var dateText = "".concat(
//    formatDate(date, "d"),
//    " ",
...
domTime.style.fontSize = config.fontSize * 1.08 + "rem";
//domDate.style.fontSize = config.fontSize * 0.6 + "rem";
